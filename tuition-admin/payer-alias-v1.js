...
(function(){
  ...
  function mount(){
    ...
    // 회비 가정목록은 숨긴 채 울산페이 빠른찾기/등록 영역만 다시 표시한다.
    const layout=document.querySelector('.layout');
    if(layout){layout.style.setProperty('display','block','important');const household=layout.querySelector(':scope > .card:first-child');if(household)household.style.setProperty('display','none','important');quick.style.display='block';quick.style.width='100%';quick.style.marginTop='14px';}
