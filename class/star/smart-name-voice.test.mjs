...
const attended=[student(1,"박윤아"),student(2,"김민규"),student(3,"이서준"),student(4,"최지우")];
const attendedIds=attended.map(s=>s.id);
...
r=resolveStudentName({alternatives:["박윤안 별"],students:attended,preferredStudentIds:attendedIds,commandTerms:terms});
assert.equal(r.level,"B");assert.equal(r.student.name,"박윤아");
r=resolveStudentName({alternatives:["박윤하 별"],students:attended,preferredStudentIds:attendedIds,commandTerms:terms});
assert.equal(r.level,"B");assert.equal(r.student.name,"박윤아");
r=resolveStudentName({alternatives:["박유나 별"],students:attended,preferredStudentIds:attendedIds,commandTerms:terms});
assert.equal(r.level,"B");assert.equal(r.student.name,"박윤아");
r=resolveStudentName({alternatives:["방윤아 별"],students:attended,preferredStudentIds:attendedIds,commandTerms:terms});
assert.equal(r.level,"B");assert.equal(r.student.name,"박윤아");
...
r=resolveStudentName({alternatives:["김민규 도전별"],students:attended,preferredStudentIds:attendedIds,commandTerms:terms});
assert.equal(r.student.name,"김민규");
r=resolveStudentName({alternatives:["박윤안 별"],students:[student(1,"박윤아"),student(2,"박윤하")],preferredStudentIds:[1,2],commandTerms:terms});
assert.equal(r.level,"C");
r=resolveStudentName({alternatives:["최고봉 별"],students:attended,preferredStudentIds:attendedIds,commandTerms:terms});
...
console.log("SMART NAME VOICE v1.1 tests: 13 passed");
